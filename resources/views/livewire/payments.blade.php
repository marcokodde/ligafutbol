...
<div class="sm:flex py-2">
    ...
    <div class="grid lg:grid-cols-3 lg:gap-2 sm:gap-1 sm:grid-cols-1">
        <div>
        </div>
        {{--  Datos Personales  --}}
        <div class="mx-auto p-2">
            ...
            <div class="mt-4 sm:mt-0">
                ...
                <x-jet-input id="phone" wire:model.lazy='phone' max_length="10" min_lenght="7" class="block mt-1 w-full sm:w-auto" type="text" name="phone" :value="old('phone')" required />
        ...
        <div class="mx-auto p-2">
            ...
            <div class='mb-2 mt-2'>
                ...
                <div class="ml-1FormFieldInput-Icons" style="opacity: 1;">
            ...
            <div class="grid grid-cols-2">
                <div class="form-group">
                    ...
                    <input class='form-control w-32 mt-2 zipcode rounded'
                ...
                <div class="form-group">
                    @if ($zipcode)
                        <input class='w-32 mt-4 form-control state rounded' name="state"
