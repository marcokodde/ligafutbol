<div class="items-center mx-auto text-center">
    <label class="block mb-2 font-bold text-gray-600 lg:text-xl sm:text-sm">
        {{__("Step 3 of 3")}}
    </label>
...
<div class="px-4 mx-4 mt-2 text-center " style="display: none" id="msg_processing_payment">
...
<div class="relative mt-4 overflow-auto rounded-xl">
    <div class="flex flex-wrap items-center justify-center sm:flex-wrap-reverse">
        ...
        <div class="lg:ml-20">
            ...
            <label class="mt-2 mb-2 font-normal text-gray-600 font-pop" for="name">{{ __('Expiration Date') }}</label>
            ...
            <div class="items-center mx-auto text-center">
                <label class="flex items-start justify-start mt-4 mr-2 font-extrabold text-gray-700">
                    <div class="flex items-center justify-center flex-shrink-0 w-6 h-6 ml-6 mr-2 bg-white border-2 border-gray-400 rounded focus-within:border-blue-500">
                    <input type="checkbox" wire:model="accept_terms" name="accept_terms" id="accept_terms"
                    class="checkbox">
                    <svg class="hidden w-4 h-4 text-green-500 pointer-events-none fill-current" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"/></svg>
                    </div>
