<div>
    <div class="sm:px-0 mx-auto text-center items-center">
        ...
        <h3 class="block mt-4 lg:text-2xl sm:text-base font-semibold leading-6 text-gray-600 p-4 uppercase text-center items-center font-pop">{{__($pages[$currentPage]['heading']) }}</h3>
    </div>
...
@if ($errors->isNotEmpty())
    <div class="text-sm bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
        ...
        <span class="block sm:inline">{{__('There are some errors with your submission.')}}</span>
    </div>
@endif
@if ($success)
