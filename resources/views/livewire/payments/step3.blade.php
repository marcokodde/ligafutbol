<div class="mx-auto text-center items-center">
    <label class="block text-lg text-gray-500 font-pop mb-2 mt-2 text-center">{{__("Please fill in the information below")}}</label>
</div>
...
<div class="relative rounded-xl overflow-auto">
    <div class="flex flex-wrap items-center justify-center sm:flex-wrap-reverse">
        {{--  Datos Personales  --}}
        <div class="sm:justify-start lg:justify-center md:justify-center lg:-mt-36">
            <label class="block text-xl text-gray-500 font-bold mb-2">{{__("Add your login password")}}:</label>
            <div>
        ...
        <div class="lg:ml-20">
            ...
            <div>
                ...
                class='block card-num lg:w-56 sm:w-32' spellcheck="false"
                inputmode="numeric"
                minlength="16"
                ...
                <div class="FormFieldInput-Icons inline" style="opacity: 1;">
            ...
            <div class="grid lg:grid-cols-2">
                <div class='form-group expiration required'>
                    <input class='lg:w-40 card-expiry-month'
                        placeholder='{{__('Month MM')}}' size='8' maxlength="2" type='text'
                        required>
                        @error('card-expiry-month') <span class="text-red-500">{{ $message }}</span>@enderror
                </div>
                <div class="form-group lg:ml-2 sm:ml-0">
                        <input class='lg:w-40 card-expiry-year'
                        placeholder='{{__('Year YYYY')}}' size='8' maxlength="4" type='text'
                        required>
