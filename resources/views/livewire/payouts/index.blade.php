<div class="max-w-full">
    <div>
        @if (isset($error_stripe))
            @include('livewire.payouts.error_stripe')
        @else
            <div>
                <div class="sm:px-0 mx-auto text-center items-center -mt-12">
                    ...
                    <h3 class="block mt-4 lg:text-2xl sm:text-base font-semibold leading-6 text-gray-600 p-4 uppercase text-center items-center font-pop">{{__('Galveston Cup Registration System 2022') }}</h3>
                </div>
                <hr class="border-2 border-gray-500">
            </div>
            <form action="{{route('makepayout')}}" method="post" role="form"
                ...
                <div class="row mx-auto">
                    <div class="py-2">
                        ...
                        <div class="mx-auto text-center items-center">
                            ...
                            <label class="block lg:text-2xl sm:text-base font-normal text-gray-500 font-pop mb-2 mt-2 text-center">
                                {{__("Your teams won't be registered without payment.")}}
                            </label>
                        </div>
                        <br>
                        <div id="card-errors"
                            class="alert-error hide text-center text-3xl font-bold text-red-500"
                            role="alert"
                            >
                        </div>
                        ...
                        @endif
                        <div class=" mx-4 px-4 mt-2 text-center" style="display: none" id="msg_processing_payment">
                            <button type="button" class="text-2xl font-pop font-semibold rounded-lg text-white bg-indigo-500 hover:bg-indigo-400 transition ease-in-out duration-150 cursor-not-allowed" disabled="">
                        ...
                        <div class="relative rounded-xl overflow-auto mt-4">
                            <div class="flex flex-wrap items-center justify-center sm:flex-wrap-reverse">
                                ...
                                <div class="card lg:w-1/4 sm:w-1/2 mx-auto justify-center">
                                    ...
                                    <div>
                                        <label class="block font-pop font-normal text-gray-600" for="phone">{{ __('Phone') }}</label>
                                        <input class="lg:w-56 sm:w-32
                                            @error('phone')
                                                border-red-600 border-2 border-collapse
                                            @enderror"
                                    ...
                                    <div>
                                        <label class="block font-pop font-normal text-gray-600" for="email">{{ __('Email') }}</label>
                                        <input class="lg:w-56 sm:w-32
                                            @error('email')
                                                border-red-600 border-2 border-collapse
                                            @enderror"
                                    ...
                                    <div>
                                        <label class="font-pop font-normal text-gray-600" for="name">{{ __('Name on card') }}</label>
                                        <input type='text'
                                            name='name'
                                    ...
                                    <div class="mx-auto items-center text-center">
                                        <label class="flex text-gray-700 justify-start items-start mr-2 mt-4 font-extrabold">
                                            ...
                                            <p><a href="https://galvestoncup.com/terminos-y-condiciones/" target="_blank" class="text-blue-500 underline">{{__("I Accept Terms and Conditions")}}</a></p>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if ($total_teams)
                            <div class="mx-auto items-center text-center">
                                <label class="block text-lg text-black font-semibold font-pop mb-2 mt-2 justify-center text-center">
                                    {{__("By clicking confirm, I authorize to register")}} {{$total_teams}} {{__('team, for a total of:')}}  <span class="font-pop text-2xl">${{$price_team}}</span>
                                </label>
                            </div>
                        @endif
                        <div>
                            <input hidden wire:model="price_team" id="price_team" name="price_team">
                            ...
                            <input hidden wire:model="fullname" id="fullname" name="fullname">
                        </div>
                        @if($accept_terms)
                        <div class="mx-auto items-center text-center">
                                <button type="submit"
