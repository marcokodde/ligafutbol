                ...
                <div class="z-50 flex items-end justify-center px-4 pt-4 pb-20 text-center bg-white border border-gray-100 shadow-lg md:rounded sm:block sm:p-0 md:w-3/5 lg:w-2/5" style="">
                    ...
                    <form>
                        <div class="mx-auto bg-white">
                            <div class="mb-4">
                                <label class="block m-2 text-sm font-bold text-left text-gray-700">{{__("Name")}}</label>
                                <input type="text" wire:model="name" maxlength="50" placeholder="{{__("Name")}}"
                                class="block w-2/4 px-3 py-2 m-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" >
                                <div>@error('name') <span class="text-red-500">{{ $message }}</span>@enderror</div>
                            </div>

                            <div class="mb-4">
                                <label class="block m-2 text-sm font-bold text-left text-gray-700">{{__("PLace")}}</label>
                                <input type="text" wire:model="place" maxlength="50" placeholder="{{__("Place")}}"
                                class="block w-2/4 px-3 py-2 m-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" >
                                <div>@error('place') <span class="text-red-500">{{ $message }}</span>@enderror</div>
                            </div>

                            <div class="mb-4">
                                <label class="block m-2 text-sm font-bold text-left text-gray-700">{{__("Location")}}</label>
                                <input type="text" wire:model="location" maxlength="50" placeholder="{{__("Location")}}"
                                class="block w-2/4 px-3 py-2 m-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline">
                            ...
                            <div class="mb-4">
                                <label class="flex items-start justify-start mt-4 mr-2 font-semibold text-gray-700">
                                    ...
                                    <input type="checkbox" wire:model="active" class="absolute m-2 checkbox" checked>
