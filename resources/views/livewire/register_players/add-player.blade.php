<div>
    <div wire:loading.delay wire:target="addingPlayer" class="flex mx-auto justify-center items-center">
        <button type="button" class="justify-center items-center text-center text-2xl font-pop font-semibold px-2 py-2  leading-6 shadow rounded-md text-white bg-indigo-500 hover:bg-indigo-400 transition ease-in-out duration-150 cursor-not-allowed" disabled="">
    ...
    <div class="flex flex-wrap mt-2">
        <div>
            <label class="block font-pop text-base">{{__('First Name')}} @error('first_name') <label class="text-red-500 text-xl inline" >*</label>@enderror</label>
            <input type="text"
        ...
        <div class="lg:ml-2 sm:ml-0">
            <label class="block font-pop text-base">{{__('Last Name')}} @error('last_name') <label class="text-red-500 text-xl inline" >*</label>@enderror</label>
            <input type="text"
        ...
        <div class="ml-1">
            <label class="block font-pop text-base">{{__('Gender')}}@error('gender') <label class="text-red-500 text-xl" >*</label>@enderror</label>
